...
tbl_names_popular |> 
  ...
  labs(
    title = 'List of popular US babynames',
    subtitle = 'no subtitle',
    caption = 'Look at this list of names',
    x = 'number of births',
    y = 'name'
  ) +
...
tbl_names_by_letter |> 
  ...
  labs(
    ...
    subtitle = "year 2020, most popular female name initial : A; most popular male name initial : J",
    x = "Percentage of  births",
    y = "First letter"
    ) +
  ...
  tbl_names_by_letter |> 
    ...
    # Add labels (title, subtitle, caption, x, y)
     labs(
      ...
      subtitle = glue::glue("Percentages of names beginning with {my_letter}"),
...
tbl_names_by_first_and_last_letter = tbl_names |> 
  ...
  mutate(pct_births = nb_births/sum(nb_births))
  # Ungroup data
  ungroup(tbl_names_by_first_and_last_letter)
```
...
tbl_names_by_first_and_last_letter |> 
  ...
  # Add labels (title, subtitle, x, y, fill)
    ...
    labs(
         ...
         subtitle =" ",
         caption = "heatmap of the percentage of  births by first  letter and    last letter for the year 2021",
         x = "First letter of the name",
         y = "Last Letter of the name",
...
tbl_names_vowel_consonant <- tbl_names |> 
 ...
 mutate(first_letter_type = tbl_names) |> 
  # Add NEW column named `last_letter_type`
 mutate(last_letter_type = tbl_names) |>
...
```
    ...
    #> # A tibble: 2,052,781 × 6
    #> # Groups:   sex, year [284]
    #>    sex    year first_letter_type$year last_letter_type$year nb_births pct_births
    #>    <chr> <dbl>                  <dbl>                 <dbl>     <dbl>      <dbl>
    #>  1 F      1880                   1880                  1880        71  0.000780 
    #>  2 F      1880                   1880                  1880         6  0.0000659
    #>  3 F      1880                   1880                  1880        12  0.000132 
    #>  4 F      1880                   1880                  1880       652  0.00717  
    #>  5 F      1880                   1880                  1880        24  0.000264 
    #>  6 F      1880                   1880                  1880        23  0.000253 
    #>  7 F      1880                   1880                  1880        14  0.000154 
    #>  8 F      1880                   1880                  1880       274  0.00301  
    #>  9 F      1880                   1880                  1880         9  0.0000989
    #> 10 F      1880                   1880                  1880        65  0.000714 
    #> # ℹ 2,052,771 more rows
    #> # ℹ 10 more variables: first_letter_type$name <chr>, $sex <chr>,
    #> #   $nb_births <dbl>, $first_letter <chr>, $last_letter <chr>,
    #> #   last_letter_type$name <chr>, $sex <chr>, $nb_births <dbl>,
    #> #   $first_letter <chr>, $last_letter <chr>
...
```
    ...
    #> Error in `mutate()`:
    #> ℹ In argument: `first_last = fct_reorder(first_last, pct_births,
    #>   median)`.
    #> ℹ In group 1: `sex = "F"`, `year = 1880`.
    #> Caused by error:
    #> ! object 'first_last' not found
